...
window.EXAMS = [
 ...
 { id:"e-n2-moji", lvl:"N2", area:"文字・語彙", title:"文字・語彙", desc:"Kanji y vocabulario",
   questions:[
     { q:"つぎの ことばの よみかたは？　彼の 意見に <u>賛成</u>します。", o:["さんせい","さんじょう","ざんせい","さんせえ"], a:0, exp:"<b>賛成 → さんせい</b> ('estar de acuerdo'). 賛=さん, 成=せい. Opuesto: 反対 (はんたい)." },
     { q:"つぎの ことばの よみかたは？　この 製品は とても <u>優秀</u>だ。", o:["ゆうしゅう","ゆうしゅ","ようしゅう","ゆしゅう"], a:0, exp:"<b>優秀 → ゆうしゅう</b> ('excelente, sobresaliente'). Las dos sílabas son largas: ゆう-しゅう." },
     { q:"「かんしん」を 漢字で かくと どれですか。（きょうみを もつ こと）", o:["関心","感心","歓心","関身"], a:0, exp:"<b>関心 (かんしん)</b> = 'interés' (tener interés en algo). ¡Ojo! 感心 (かんしん) = 'admiración': mismo sonido, distinto kanji." },
     { q:"（　）に 入る ことばは？　「彼は 約束を 破った。私は とても （　）した。」", o:["がっかり","びっくり","うっかり","すっきり"], a:0, exp:"<b>がっかり(する)</b> = 'decepcionarse'. びっくり=sorprenderse, うっかり=por descuido, すっきり=despejado." },
     { q:"「その 計画は 実現した。」に いちばん 近い いみは？", o:["本当に できた","中止に なった","おくれた","失敗した"], a:0, exp:"<b>実現 (じつげん)</b> = 'hacerse realidad'. 計画が実現した = el plan se llevó a cabo." },
     { q:"（　）に 入る ことばは？　「地震で 電車が （　）して しまった。」", o:["停止","中止","禁止","防止"], a:0, exp:"<b>停止 (ていし)</b> = 'detenerse' (algo se para). 中止=cancelar (evento), 禁止=prohibir, 防止=prevenir." }
   ]
 },

 { id:"e-n2-bunpou", lvl:"N2", area:"文法", title:"文法", desc:"Gramática",
   questions:[
     { q:"さすが プロ（　）、すばらしい えんそうだ。", o:["だけあって","だけで","ばかりに","につれて"], a:0, exp:"<b>〜だけあって</b> = 'como cabe esperar de…' (resultado admirable y coherente): さすがプロだけあって." },
     { q:"部長に （　）、私が あいさつを いたします。", o:["かわって","たいして","ついて","おいて"], a:0, exp:"<b>〜にかわって</b> = 'en lugar de / en nombre de…': 部長にかわって あいさつする." },
     { q:"この 問題は 複雑な（　）、簡単には 解決できない。", o:["だけに","だけで","うえに","ものの"], a:0, exp:"<b>〜だけに</b> = 'precisamente porque…' (intensifica el resultado): 複雑なだけに…." },
     { q:"天気予報に （　）、明日は 雨らしい。", o:["よると","よって","たいして","おうじて"], a:0, exp:"<b>〜によると</b> = 'según…' (fuente de información); suele cerrar con らしい/そうだ." },
     { q:"彼は 忙しい（　）、必ず 返事を くれる。", o:["にもかかわらず","からこそ","ばかりか","どころか"], a:0, exp:"<b>〜にもかかわらず</b> = 'a pesar de…': 忙しいにもかかわらず 返事をくれる." },
     { q:"ただしい 文を えらんで ください。", o:["台風の ため、旅行を 中止せざるを得ない。","台風の ため、旅行を 中止せざるを得る。","台風の ため、旅行を 中止しざるを得ない。","台風の ため、旅行を 中止するざるを得ない。"], a:0, exp:"<b>〜ざるを得ない</b> = 'no queda más remedio que'. Irregular: する→<b>せ</b>ざるを得ない (no しざる ni するざる)." }
   ]
 },

 { id:"e-n2-dokkai", lvl:"N2", area:"読解", title:"読解", desc:"Comprensión lectora",
   questions:[
     { passage:"技術の 進歩により、私たちの 生活は 便利に なった。しかし、その 一方で、人と 直接 話す 機会が 減り、コミュニケーション能力の 低下を 心配する 声も ある。", q:"筆者が 心配して いる ことは 何か。", o:["コミュニケーション能力の 低下","技術の 進歩","生活の 不便さ","機会の 増加"], a:0, exp:"'コミュニケーション能力の 低下を 心配する 声' → preocupa la caída de la capacidad comunicativa." },
     { passage:"新しい 制度を 導入する にあたって、社員から さまざまな 意見が 出された。中には 反対の 意見も あったが、話し合いを 重ねた 結果、全員が 納得する 形で 決まった。", q:"新しい 制度は どのように 決まったか。", o:["話し合いを 重ねて 全員が 納得して","社長が 一人で 決めて","反対が なかったので すぐに","社員の 投票で"], a:0, exp:"'話し合いを 重ねた 結果、全員が 納得する 形で 決まった' → tras varias reuniones y con el acuerdo de todos." },
     { passage:"読書には、知識を 得る だけでなく、他人の 気持ちを 想像する 力を 育てる 効果が あると 言われて いる。だからこそ、子どもの ころから 本に 親しむ ことが 大切なのだ。", q:"筆者が 読書を すすめる 理由は 何か。", o:["想像する 力が 育つから","成績が 上がるから","時間が つぶせるから","有名に なれるから"], a:0, exp:"'他人の 気持ちを 想像する 力を 育てる 効果' → la lectura desarrolla la capacidad de imaginar/empatizar." },
     { passage:"この 会社では、社員の 健康を 守る ため、残業を 減らす 取り組みを 始めた。最初は 戸惑う 社員も いたが、今では 仕事の 効率が むしろ 上がったと いう。", q:"取り組みの 結果、どう なったか。", o:["仕事の 効率が 上がった","残業が 増えた","社員が 減った","給料が 下がった"], a:0, exp:"'今では 仕事の 効率が むしろ 上がった' → al final la eficiencia del trabajo subió." }
   ]
 },

 { id:"e-n2-choukai", lvl:"N2", area:"聴解", title:"聴解", desc:"Comprensión auditiva",
   questions:[
     { audio:"では、明日の 予定について 連絡します。集合は 午前 9時、駅の 北口です。雨の 場合は 中止に なりますので、朝 7時までに メールを 確認して ください。", q:"雨の 場合、どう なりますか。", o:["中止に なる","時間が 変わる","場所が 変わる","予定どおり 行う"], a:0, exp:"'雨の 場合は 中止に なります' → si llueve, se cancela." },
     { audio:"すみません、先週 注文した 商品が まだ 届いて いないん ですが。　申し訳 ございません。確認した ところ、来週の 月曜日に お届けの 予定です。", q:"商品は いつ 届きますか。", o:["来週の 月曜日","今週の 金曜日","もう 届いた","わからない"], a:0, exp:"'来週の 月曜日に お届けの 予定' → llega el lunes que viene." },
     { audio:"会議室の 予約なんですが、金曜日の 午後は もう 埋まって いますね。木曜日の 午後なら 空いて いますが、いかがですか。　じゃあ、木曜日で お願いします。", q:"会議室を いつ 予約しますか。", o:["木曜日の 午後","金曜日の 午後","木曜日の 午前","金曜日の 午前"], a:0, exp:"'金曜の 午後は 埋まって…木曜日の 午後なら 空いて' → reservan el jueves por la tarde." },
     { audio:"新入社員の みなさんへ。研修は 全部で 三日間 あります。一日目は 会社の 説明、二日目は 工場の 見学、三日目は 実際の 仕事を 体験して もらいます。", q:"二日目は 何を しますか。", o:["工場の 見学","会社の 説明","仕事の 体験","試験"], a:0, exp:"'二日目は 工場の 見学' → el segundo día, visita a la fábrica." }
   ]
 }
