...
var CACHE = "n1path-v13";                 /* ← subido: fuerza recargar el menú/HTML nuevo y descartar caché vieja */
...
var SHELL = ["./", "./index.html", "./content.js", "./reading.js", "./listening.js", "./manifest.json", "./icon.png"];
